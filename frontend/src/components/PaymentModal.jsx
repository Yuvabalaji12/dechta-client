...
export default function PaymentModal({ open, onClose, onSuccess, orderData }) {
    const { cartItems, cartTotal, finalTotal, discountAmount, couponApplied, getMaxTier } = useCart();
    ...
    const deliveryFees = { 1: 30, 2: 80, 3: 200 };
    const deliveryFee = deliveryFees[getMaxTier()] || 30;
